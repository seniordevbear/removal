# specialtycontactdatabasescom.py -- auto-generated stub
...
def specialtycontactdatabasescom(*args, **kwargs):
    raise ModuleNotFoundError("sites_scan.specialtycontactdatabasescom")
