# 33acrosscom.py -- auto-generated stub
...
#
# `33acrosscom` starts with a digit, so it is not a valid Python identifier and
# `def 33acrosscom(...)` is a SyntaxError -- which is NOT a ModuleNotFoundError,
...
# the working removal script sites/33acrosscom.py already uses.

def _stub(*args, **kwargs):
    raise ModuleNotFoundError("sites_scan.33acrosscom")


globals()["33acrosscom"] = _stub
