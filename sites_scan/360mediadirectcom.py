# 360mediadirectcom.py -- auto-generated stub
...
#
# `360mediadirectcom` starts with a digit, so it is not a valid Python identifier and
# `def 360mediadirectcom(...)` is a SyntaxError -- which is NOT a ModuleNotFoundError,
...
# the working removal script sites/360mediadirectcom.py already uses.

def _stub(*args, **kwargs):
    raise ModuleNotFoundError("sites_scan.360mediadirectcom")


globals()["360mediadirectcom"] = _stub
