...
#
# `411com` starts with a digit, so it is not a valid Python identifier and
# `def 411com(...)` is a SyntaxError -- which is NOT a ModuleNotFoundError,
...
# the working removal script sites/411com.py already uses.

def _stub(*args, **kwargs):
    raise ModuleNotFoundError("sites_scan.411com")


globals()["411com"] = _stub
