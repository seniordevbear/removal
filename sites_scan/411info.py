# 411info.py -- auto-generated stub
...
#
# `411info` starts with a digit, so it is not a valid Python identifier and
# `def 411info(...)` is a SyntaxError -- which is NOT a ModuleNotFoundError,
...
# the working removal script sites/411info.py already uses.

def _stub(*args, **kwargs):
    raise ModuleNotFoundError("sites_scan.411info")


globals()["411info"] = _stub
