...
def fill_input_data(page, dataRow) : 
    ...
    page.wait.ele_displayed("tag:span@@text()= Consumer ")
    sleep(1)

    request_man = page.ele("tag:span@@text()= Consumer ")
    request_man.click()

    request_type = page.ele("tag:span@@text()= Request to Delete Personal Information ")
    request_type.click()
...
def buyerlinkcom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\BuyerlinkCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://privacyportal.onetrust.com/webform/27aa5d67-8136-4a08-ae4b-9860992e2375/4e34d8c3-8173-42da-97dc-7774750fbca9")
