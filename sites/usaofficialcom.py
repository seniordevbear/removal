...
def fill_input_data(page, dataRow) : 
    ...
    url_str = "https://usa-official.com/" + fName + "-" + lName
...
def usaofficialcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + r"\UsaofficialCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://usa-official.com/remove.php")
