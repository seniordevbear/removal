...
def myypcom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\MyypCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.myyp.com/optout")
        ...
        try :
            site_key = "6Led9b0UAAAAAOBVr7JI1h9OYPnOTNesUMweuoKO"
            site_url = "https://www.myyp.com/optout"
