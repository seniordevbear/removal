...
def fill_input_data(page, dataRow) : 
    ...
    subject_select.select.by_text("Would like my information removed")
...
def peoplebynamecom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\PeopleByNameCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.peoplebyname.com/contact.php")
        ...
        try :
            site_key = "6Lc2JBQTAAAAAAe92x2AaH3HnhSMQkTJv6K-wyQk"
            site_url = "https://www.peoplebyname.com/contact.php"
        ...
        submit_button = page.ele("tag:input@@id=imageField")
        submit_button.click()
