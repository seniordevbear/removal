...
# form at https://www.fastbackgroundcheck.com/opt-out: select am=subject, name/email fields, legal checkbox,
...
def fastbackgroundcheckcom(dataRow, website_name, in_user_email, run_mode):
    ...
    with safe_chromium_for_broker(broker,
        ...
        try:
            log_step(broker, "GET https://www.fastbackgroundcheck.com/opt-out")
            page.get("https://www.fastbackgroundcheck.com/opt-out")
            sleep(3)
