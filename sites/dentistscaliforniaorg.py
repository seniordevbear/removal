...
def dentistscaliforniaorg(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        screenshot_save_path = screentShotDir + "\DentistscaliforniaOrg_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.dentistscalifornia.org/")
