...
def smartbackgroundcheckscom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\SmartBackgroundChecksCom_" + fName + "-" + lName + ".png"
        ...
        checkbox = page.ele("tag:input@@id=accept_terms")
        checkbox.click()
        ...
        try :
            site_key = "6LfrTZYeAAAAAIHiEeAsmSQCjVNoI81kuyTLrbgi"
            site_url = "https://www.smartbackgroundchecks.com/optout"
