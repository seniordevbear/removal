...
def counciloncom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    try : 
        ...
        screenshot_save_path = screentShotDir + "\CouncilonCom_" + fName + "-" + lName + ".png"
        ...
        if len(rows) > 0 :
            ...
            sleep(1)
            page.get("https://councilon.com/ex/control/privacy")        
            ...
            print(generate_email(dataRow["Name"]))
            ...
            try:
                SITE_KEY = "0x4AAAAAAAB9SjyoC1xrh1fc"
                result = solver.turnstile(sitekey=SITE_KEY, url="https://councilon.com/ex/control/privacy")
                Code=result['code']
