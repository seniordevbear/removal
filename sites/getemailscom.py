...
def fill_input_data(page, dataRow) : 
    ...
    email_input = page.ele("tag:input@@name=optout-email")
    email_input.click()
    print("typing the email...")
    sleep(random.uniform(0.1,0.5))
    _human_type2(email_input, generate_email(dataRow["Name"]))

    zip_input = page.ele("tag:input@@name=optout-zipcode")
    zip_input.click()
    sleep(random.uniform(0.1,0.5))
...
def getemailscom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\GetEmailsCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://app.retention.com/optout/")
        ...
        try :
            ...
            site_url = "https://app.retention.com/optout/"
