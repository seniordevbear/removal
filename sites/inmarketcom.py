...
def fill_input_data(page, dataRow) : 
    ...
    fullName_input = page.ele("tag:input@@name=full-name")
...
def inmarketcom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\InmarketCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://inmarket.com/opt-out/")
        ...
        try :
            site_key = "6LdGQawZAAAAAIC6mCbTmns4prQagG2hGyHpvjHp"
            site_url = "https://inmarket.com/opt-out/"
        ...
        submit_button = page.ele("tag:input@@value=Send")
        submit_button.click()
