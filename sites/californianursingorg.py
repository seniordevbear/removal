...
def californianursingorg(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        ...
        screenshot_save_path = screentShotDir + "\CaliforniaNursingOrg_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.californianursing.org/")
