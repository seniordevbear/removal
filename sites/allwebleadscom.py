...
def allwebleadscom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\AllWebLeadsCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://dnc.allwebleads.com/Unsubscribe")
        ...
        try :
            site_key = "6LcV1xkUAAAAAPiEfBiXh27QZQ4uTDvSrbWpu48N"
            site_url = "https://dnc.allwebleads.com/Unsubscribe"
        ...
        form_container = page.ele("tag:form@@id=dnc-form")      
