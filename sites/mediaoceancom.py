...
def fill_input_data(page, dataRow) : 
    ...
    request_type = page.ele("tag:select@@id=cCPARequest")
    request_type.select.by_value("CCPA Delete Info")

def mediaoceancom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\MediaOceanCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.mediaocean.com/your-privacy-rights")
