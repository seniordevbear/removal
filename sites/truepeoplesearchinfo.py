...
def truepeoplesearchinfo(dataRow, website_name, in_user_email) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\TruePeopleSearchInfo_" + fName + "-" + lName + ".png"
        ...
        page.get("https://truepeoplesearch.info/optout")
        ...
        try :
            ...
            site_url = "https://truepeoplesearch.info/optout"
