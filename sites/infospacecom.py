...
def fill_input_data(page, dataRow) : 
    ...
    request_type_select = iframe_container.ele("tag:input@@id=requestTypesDSARElement")
    request_type_select.click()
    sleep(random.uniform(0.1,0.5))
    iframe_container.ele("tag:vt-option@@text()= Data Deletion ").click()

    website_input = iframe_container.ele("tag:input@@id=formField50DSARElement")
    website_input.click()
    print("typing the website name...")
    sleep(random.uniform(0.1,0.5))
    _human_type2(website_input, "infospace.com")
    ...
    detail_input = iframe_container.ele("tag:textarea@@id=requestDetailsDSARElement")
    detail_input.click()
    sleep(random.uniform(0.1,0.5))
    _human_type2(detail_input, "I want to remove my info.")

def infospacecom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\InfoSpaceCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://system1.com/terms/privacy-policy/privacy-inquiries")
