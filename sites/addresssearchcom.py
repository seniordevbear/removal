...
def addresssearchcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\AddresssearchCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.addresssearch.com/remove-info.php")

        sleep(random.uniform(1, 2))

        fill_input_data(page, dataRow)

        submit_button = page.ele("tag:input@@name=submit")
        submit_button.click()
