...
def dicecom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\DiceCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.dice.com/about/ccpa#ccpa-form-anchor")

        fill_input_data(page, dataRow)
        
        sleep(random.uniform(0.5, 1))
        radio_element = page.ele("tag:input@@id=radio-description-optout")
        radio_element.click()
        ...
        try :
            site_key = "6LfGIN8UAAAAAABoxqi4tP_1mD3OBzwKTTauYrDR"
            site_url = "https://www.dice.com/about/ccpa#ccpa-form-anchor"
