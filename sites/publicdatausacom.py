...
def fill_input_data(page, dataRow) : 
    ...
    url_str = "https://publicdatausa.com/" + dataRow["Name"]
...
def publicdatausacom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\PublicDataUsaCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://publicdatausa.com/remove.php")
        ...
        try :
            site_key = "6Lfr7qUUAAAAAPYxq7Hz4Jncsiz4tIElJkoLVVpQ"
            site_url = page.url
        ...
        submit_button = page.ele("tag:button@@text()=Continue")
        submit_button.click()
