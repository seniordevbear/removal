...
def propeoplesearchcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\ProPeopleSearchCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://propeoplesearch.com/optout")
        ...
        try :
            site_key = "6Lfp9Y4UAAAAAJw3CrFt2zp5yhMAwnri4-ftYsqv"
            site_url = "https://propeoplesearch.com/optout"
