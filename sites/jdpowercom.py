...
def fill_input_data(page, dataRow) : 
    ...
    request_type = page.ele("tag:span@@text()= Yes ")
    request_type.click()

    request_type1 = page.ele("tag:span@@text()= Both ")
    request_type1.click()

def jdpowercom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\JdpowerCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://privacyportal.onetrust.com/webform/5e27ce89-3714-4976-8df7-1d1560e32aa1/d6419967-880f-480f-9935-960045988858")
