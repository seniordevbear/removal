...
def kidslivesafecom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\KidsliveSafeCom_" + fName + "-" + lName + ".png"
        ...
        # page.load_mode=None
        page.get("https://www.kidslivesafe.com/help-center/privacy-requests")
        ...
        try:
            ...
            result = solver.turnstile(sitekey=SITE_KEY, url="https://www.kidslivesafe.com/help-center/privacy-requests")
            Code=result['code']
