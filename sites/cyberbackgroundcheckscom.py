...
def cyberbackgroundcheckscom(dataRow, website_name, in_user_email, run_mode):
    page = None
    ...
    try :
        ...
        screenshot_save_path = screentShotDir + "\CyberbackgroundchecksCom_" + fName + "-" + lName + ".png"
        ...
        confirm_checkbox = page.ele("tag:label@@for=chk-agree-to-terms")
        ...
        try :
            site_key = "6LeueAYfAAAAADx3Bxm0F6wZnaHvhKu9xJ2TduSc"
            site_url = "https://www.cyberbackgroundchecks.com/removal"
        ...
        submit_btn = page.ele("tag:button@@text():Send Request")
        print(submit_btn)
