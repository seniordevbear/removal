...
def offenderradarcom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\OffenderradarCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.offenderradar.com/contact-us")
        ...
        try :
            site_key = "6LdljI8UAAAAAFoP5kye6DI3nJvwrO8Kuh-XdFic"
            site_url = "https://www.offenderradar.com/contact-us"
        ...
        submit_button = page.ele("tag:button@@id=sendbtn")
        submit_button.click()
