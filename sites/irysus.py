...
def fill_input_data(page, dataRow) : 
    ...
    page.wait.eles_loaded("tag:span@@text()= Data Deletion Request ")
    
    request_type = page.ele("tag:span@@text()= Data Deletion Request ")
    request_type.click()
...
def irysus(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\IrysUs_" + fName + "-" + lName + ".png"
        ...
        page.get("https://privacyportal-cdn.onetrust.com/dsarwebform/889c435d-64b4-46d8-ad05-06332fe1d097/e46e14fd-a842-4e85-b6a0-1a9b09ae3baf.html?originSite=img.com")
