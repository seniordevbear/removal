...
def verecorcom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    raise NotImplementedError("verecorcom: domain seized by court order (2026-09-18)")
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\VerecorCom_" + fName + "-" + lName + ".png"
        ...
        if len(people_list) > 0 :
            ...
            print(profile_url)
            page.get("https://verecor.com/ng/control/privacy")
            sleep(1)
            ...
            try :
                site_key = "6LeCl8UUAAAAAGssOpatU5nzFXH2D7UZEYelSLTn"
                site_url = "https://verecor.com/ng/control/privacy"
