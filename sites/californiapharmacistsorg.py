...
def californiapharmacistsorg(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        screenshot_save_path = screentShotDir + "\CaliforniaPharmacistsOrg_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.californiapharmacists.org/")
