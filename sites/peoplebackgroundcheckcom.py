...
def peoplebackgroundcheckcom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    raise NotImplementedError("peoplebackgroundcheckcom: domain seized by court order (2026-09-18)")
    page = None
    try : 
    
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\PeopleBackgroundCheckCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://people-background-check.com/")
        ...
        if len(people_list) > 0 :
            ...
            print(profile_url)
            page.get("https://people-background-check.com/ng/control/privacy")
            sleep(2)
