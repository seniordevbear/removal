...
def equifaxcom(dataRow, website_name, in_user_email, run_mode) : 
    ...
    try : 
        ...
        screenshot_save_path = screentShotDir + "\EquifaxCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://myprivacy.equifax.com/personal-info")

        sleep(1)

        firstName_input = page.ele("tag:input@@id=firstname")
        firstName_input.input(fName)

        sleep(0.5)

        lastName_input = page.ele("tag:input@@id=lastname")
        ...
        birth_input = page.ele("tag:input@@id=dateOfBirth")
        birth_input.input(birthday)
        sleep(0.5)

        SSN_input = page.ele("tag:input@@id=SSNMasked")
        SSN_input.input("333333333")
        ...
        phone_input = page.ele("tag:input@@id=mobileNumber")
        phone_input.input(dataRow["Phone Number"])

        sleep(0.5)

        address_input = page.ele("tag:input@@id=address1")
        ...
        zip_input = page.ele("tag:input@@id=zipCode")
        zip_input.input(str(dataRow["Zipcode"]))

        checkbox = page.ele("tag:div@@class:mat-checkbox-inner-container")
        checkbox.click()
