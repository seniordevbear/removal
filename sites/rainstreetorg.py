...
def fill_input_data(page, dataRow) : 
    ...
    fullName_input = page.ele("tag:input@@name=username")
...
def rainstreetorg(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\RainStreetOrg_" + fName + "-" + lName + ".png"
        ...
        page.get("https://rain-street.org/page/contact")
        ...
        submit_button = page.ele("tag:button@@type=submit@@class=button-submit")
        submit_button.click()
