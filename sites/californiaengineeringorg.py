...
def californiaengineeringorg(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        ...
        screenshot_save_path = screentShotDir + "\CaliforniaEngineeringoOrg_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.californiaengineering.org/")
