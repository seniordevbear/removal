...
def fill_input_data(page, dataRow) : 
    ...
    address_input = page.ele("tag:input@@id=address")
    address_input.click()
    sleep(random.uniform(0.1,0.5))
...
def fastpeoplesearchinfo(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\FastPeoplesearchInfo_" + fName + "-" + lName + ".png"
        ...
        page.get("https://fastpeoplesearch.info/optout")
        ...
        try :
            site_key = "6Len82UeAAAAAKunVNTjCfWiT4Ef5sNvsK8VRu0S"
            site_url = "https://fastpeoplesearch.info/optout"
