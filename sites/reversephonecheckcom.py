...
def fill_input_data(page, dataRow) : 
    ...
    phone_input = page.ele("tag:input@@id=phoneNumber")
    phone_input.click()
...
def reversephonecheckcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\ReversePhoneCheckCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://www.reversephonecheck.com/optout/")
        ...
        try :
            site_key = "6Lcg7PApAAAAAHdkkd0wlruVztBgSu2c98iHZwcQ"
            site_url = "https://www.reversephonecheck.com/optout/"
