...
def fill_input_data(page, dataRow) : 
    ...
    checkbox_input = page.ele("tag:p@@text()=Deletion of my Personal Information")
    ...
    email_input = page.ele("tag:input@@name=Email address")
    email_input.click()
...
def demystcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        screenshot_save_path = screentShotDir + "\DemystCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://demyst.com/personal-information-request-california")
