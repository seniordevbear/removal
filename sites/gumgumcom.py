...
def fill_input_data(page, dataRow) : 
    ...
    sender_type = page.ele("tag:span@@text()= Client ")
    sender_type.click()
...
def gumgumcom(dataRow, website_name, in_user_email, run_mode) : 
    try : 
        ...
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\GumgumCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://privacyportal-cdn.onetrust.com/dsarwebform/fbe4d6b4-7f02-4251-bc4b-142d5109ae3e/1683277a-0ae1-47dd-8845-5e811a07e307.html")
