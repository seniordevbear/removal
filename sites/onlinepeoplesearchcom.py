...
def onlinepeoplesearchcom(dataRow, website_name, in_user_email, run_mode) : 
    page = None
    try : 
        fName = dataRow["Name"].split()[0] # split string based on space to get first name
        lName = dataRow["Name"].split()[-1]# split string based on space to get last name
        screenshot_save_path = screentShotDir + "\OnlinePeopleSearchCom_" + fName + "-" + lName + ".png"
        ...
        page.get("https://onlinepeoplesearch.com/optout")
        ...
        try :
            site_key = "6Ld0gK4UAAAAAORb5n37bEd7zJ9DXh1EO4brVhZ6"
            site_url = "https://onlinepeoplesearch.com/optout"
